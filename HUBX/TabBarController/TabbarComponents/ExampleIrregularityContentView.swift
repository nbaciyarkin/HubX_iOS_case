...
class ExampleIrregularityBasicContentView: ExampleBouncesContentView {
    ...
    override init(frame: CGRect) {
        ...
        textColor = UIColor(named: "app_gray") ?? .gray
        highlightTextColor = UIColor.init(named: "app_green")!
        iconColor = UIColor(named: "app_gray") ?? .gray
        highlightIconColor = UIColor.init(named: "app_green")!
        backdropColor = .white
...
class ExampleIrregularityContentView: ESTabBarItemContentView {
    ...
    override init(frame: CGRect) {
        ...
        self.imageView.backgroundColor = UIColor(named: "app_green") ?? .gray
        self.imageView.layer.borderWidth = 4.0
        self.imageView.layer.borderColor = (UIColor(named: "transparent_green") ?? UIColor.green).withAlphaComponent(1).cgColor
